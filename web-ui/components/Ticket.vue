  ...
  <div class="col-md-3 col-12 py-4">
    <div class="card">
      <div class="card-header animated-bg" id="header">
        <h1 class="text-center" style="font-weight: bold">T-CALL TICKET</h1>
      </div>
      <div class="card-content">
        <h3 class="card-title text-center" id="title">T-CALL | TICKET CLIENT</h3>
        ...
        <div class="author">
          ...
          <div class="author-info">
            <strong class="" id="name">{{  ticket.watcher_nbr }}</strong>
            <div class="row">
              <div class="col-md-12 mt-2">
                <small class="" id="event-btn">
                    <button @click="call(ticket)" v-if="ticket.status === 'WAITING'" :class="!ticket.can_be_called ? 'disabled btn btn-success' : 'btn btn-success'" id="btn1">Appeler</button>
              ...
              <div class="col-md-12 mt-2">
                <small class="animated-bg animated-bg-text" id="date">
                    <button @click="markServed(ticket)" v-if="ticket.status === 'RECEIVE'" :class="!ticket.can_be_marked_served ? 'disabled btn btn-success' : 'btn btn-success'" id="btn2">Marquer traité</button>
                </small>
              </div>
            </div>
          </div>
