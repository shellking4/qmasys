<template>
  <div class="container">
    <div class="row" style="padding-bottom: 5px; margin-top: 20px">
      <Ticket v-for="ticket in tickets_list()" :key="ticket.id" :ticket="ticket" />
    </div>
    <div v-if="tickets.length !== 0" class="pagination-container" style="padding-bottom: 80px; margin-top: 80px">
      <ul class="pagination">
        <li class="pageItem">
          <a
            class="page-link"
